...
export const CtaFinal = () => (
  <section className="relative overflow-hidden bg-gradient-primary py-16 sm:py-20 md:py-28">
    ...
    >
      ...
      <h2 className="font-display text-3xl font-medium leading-tight text-primary-foreground sm:text-4xl md:text-6xl">
        Viver bem é resultado de um corpo em{" "}
        <span className="italic">harmonia.</span>
      </h2>
      <p className="mx-auto mt-6 max-w-xl text-sm text-primary-foreground/90 sm:text-base md:text-lg">
